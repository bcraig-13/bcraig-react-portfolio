      ...
      <div className="row">
        <div className="col-sm-12 col-md-12">
          ...
          <p>I attended an extension through UC San Diego and earned my certificate in web design after a three month bootcamp. Prior to attending
            coding bootcamp I had no prior experience with coding. I was able to pick things up pretty quickly, and over three months I learned many skills including:
          </p>
          <table>
            <tr>
              <td>-HTML5</td>
