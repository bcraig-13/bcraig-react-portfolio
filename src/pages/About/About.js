    ...
    <div className="container container-fluid cardbox block-one" style={{marginTop:"100px"}}>
      ...
      <div className="row">
        <div className="col-sm-12 col-md-12">
          <img src={me} alt="Brandon Craig Profile Picture" className="img-fluid float-left mr-5 mb-2" title="Ugh...I need a better picture."></img>
      ...
      <div className="row">
        <div className="col-sm-12 col-md-12">
          ...
          <p>
            Click{" "}
            <a href="https://drive.google.com/file/d/1difBDVvDQHclO7V9Tz_St6KBEG83npG2/view?usp=sharing" target="_blank">
              here
            </a>{" "}
